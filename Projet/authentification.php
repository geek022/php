...
<body>
  ...
  if ($_SESSION['connecte'] === true) {
    ...
    if (isset($_POST['btn'])) {
      ...
      echo '<input type="email" class="form-control solid" id="email" placeholder="Enter email" name="email" required>';
      echo '<label for="pwd">Mot de passe</label>';
      echo '<input type="password" class="form-control solid" id="pwd" placeholder="Enter password" name="mdp" required><br>';
